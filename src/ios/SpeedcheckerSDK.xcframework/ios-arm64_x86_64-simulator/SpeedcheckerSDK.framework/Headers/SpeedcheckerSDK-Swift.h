...
///
- (nonnull instancetype)initWithTestsEnabled:(BOOL)testsEnabled OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithIsBackground:(BOOL)isBackground delegate:(id <InternetSpeedTestDelegate> _Nonnull)delegate OBJC_DESIGNATED_INITIALIZER;
